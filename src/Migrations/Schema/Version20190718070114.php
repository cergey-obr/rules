...
class Version20190718070114 extends AbstractMigration
{
    ...
    private function createCombinationTable(Schema $schema): Table
    {
        ...
        $combinationTable->addColumn('aggregator', Type::STRING)->setColumnDefinition('ENUM("all", "any") NOT NULL');
        $combinationTable->addColumn('operator', Type::STRING)->setColumnDefinition($this->operatorEnum);
    ...
    private function createConditionTable(Schema $schema): Table
    {
        ...
        $conditionTable->addColumn('operator', Type::STRING)->setColumnDefinition($this->operatorEnum . ' NOT NULL');
